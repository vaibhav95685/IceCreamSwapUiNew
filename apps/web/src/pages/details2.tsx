...
import { Text, Farm as FarmUI, SearchInput, Select, Checkbox, Flex, PageHeader, Card } from '@pancakeswap/uikit'
...
const MultiStepForm = () => {
  ...
  return (
    <PageHeader>
      <AppBody>
        <div
          style={{ paddingTop: '50px', paddingBottom: '100px', marginLeft: 'auto', marginRight: 'auto', width: '85%' }}
        >
        ...
        >
          <AtomBox width="full" alignItems="center" flexDirection="column" padding="24px" borderBottom="1">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', width:"30%" }}>
              ...
              <h2 style={{ color: '#f8567f', fontSize: '25px' }}>AI District</h2>
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', width:"30%" }}>
              <Text color="textSubtle" fontSize="12px" textAlign="left">
                Total Supply
              </Text>
              <h2 style={{ color: '#f8567f', fontSize: '25px' }}>1,000,000,000 AID</h2>
            </div>
            <div style={{ display: 'flex', flexDirection: 'column' , width:"30%" }}>
              <Text color="textSubtle" fontSize="12px" textAlign="left">
                Tokens For Presale
              </Text>
              <h2 style={{ color: '#f8567f', fontSize: '25px' }}>369,000,000 AID</h2>
            </div>
            </div>
          ...
          <div style={{display: 'flex', flexDirection: 'row', justifyContent:"space-evenly"  }}>
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              ...
              <h2 style={{ color: '#f8567f', fontSize: '25px' }}>173,555,550 AID</h2>
            </div>
            <div style={{ display: 'flex',  flexDirection: 'column' }}>
              <Text color="textSubtle" fontSize="12px" textAlign="left">
                Presale rate
              </Text>
              <h2 style={{ color: '#f8567f', fontSize: '25px' }}>1 BNB = 1,230,000 AID</h2>
            </div>
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              <Text color="textSubtle" fontSize="12px" textAlign="left">
                First Release For Presale
              </Text>
              <h2 style={{ color: '#f8567f', fontSize: '25px' }}>50%</h2>
            </div>
            </div>
          </AtomBox>
        </div>
