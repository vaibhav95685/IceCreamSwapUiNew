...
import { Tag, Flex, Heading, Box,Text, Skeleton, Farm as FarmUI } from '@pancakeswap/uikit'
  ...
  return (
    <Wrapper justifyContent="space-between" alignItems="center" mb="12px">
      ...
      <Flex flexDirection="column" alignItems="flex-end">
        {isReady ?  <Text marginBottom={"10px"} color="#32CD32" fontSize="17px" textAlign="left" >
                    Sale Live
                  </Text> : <Skeleton mb="4px" width={60} height={18} />}
